      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => DashboardScreenWidget(
            dashboardResponse: params.getParam(
              'dashboardResponse',
              ParamType.DataStruct,
              isList: false,
              structBuilder: DashboardResponseModelStruct.fromSerializableMap,
            ),
          ),
        ),
        FFRoute(
          name: TicketCreationScreenWidget.routeName,
          path: TicketCreationScreenWidget.routePath,
          builder: (context, params) => TicketCreationScreenWidget(),
        )
